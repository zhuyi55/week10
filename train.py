...
########################
## code added for fcn 8x
# perform second upsampling x2
...
upsample_filter_np_x2_2nd = bilinear_upsample_weights(2, number_of_classes)

upsample_filter_tensor_x2_2nd = tf.Variable(upsample_filter_np_x2_2nd, name='vgg_16/fc8/t_conv_x2_2nd')

upsampled_logits = tf.nn.conv2d_transpose(upsampled_logits, upsample_filter_tensor_x2_2nd,
...
vgg_except_fc8_weights = slim.get_variables_to_restore(exclude=['vgg_16/fc8', 'adam_vars', 'vgg_16/fc7'])
